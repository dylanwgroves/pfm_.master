...
/* Environment Causes __________________________________________________________*/
	...
	recode env_cause (4 5 6 7 8 = 2)(1 2 3 9 10 -222 -999 .d .o = 0), gen(enviro_cause_human)		// DWG: for outcome measure, do we want to set this to zero if they got the meaning of climate change wrong
	...
	recode env_cause (7 = 1)(1 2 3 4 5 6 8 9 10 -222 -999 .d .o = 0), gen(enviro_cause_intl)
