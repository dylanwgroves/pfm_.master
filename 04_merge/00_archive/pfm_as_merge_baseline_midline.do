...
/* Load Midline */
use  "X:\Dropbox\Wellspring Tanzania Papers\wellspring_01_master\01_data\01_raw_data\pfm_as_midline_clean.dta", clear 
sort  resp_id


/* Merge ______________________________________________________________________*/

merge 1:1 resp_id using `baseline', force gen(merge_as_base_mid)
order resp_id resp_name district_name ward_name village_name merge_as_base_mid
sort resp_id


/* Save ______________________________________________________________________*/

save "X:\Dropbox\Wellspring Tanzania Papers\wellspring_01_master\01_data\02_mid_data\pfm_as_merged_base_mid.dta", replace
