...
keep  district_code district_name ward_code ward_name village_code village_name resp_name resp_id s1q5_village s2q1_gender radiorandomization_treat radiorandomization_pair cases_phone1 cases_phone2 cases_hhh_name cases_hhh_phone village_id pca1
...
keep district_code district_name ward_code ward_name village_code village_name resp_name resp_id s2q1_gender cases_phone1 cases_phone2 cases_hhh_name cases_hhh_phone pca1 radiorandomization_treat radiorandomization_pair village_id

if  ${i} == 1 {
	save "$pfm2/04_checks/02_outputs/DG_panganifm2_radiodistribution_master.dta", replace
}

if ${i} > 1 {
	append using "$pfm2/04_checks/02_outputs/DG_panganifm2_radiodistribution_master.dta"
	save "$pfm2/04_checks/02_outputs/DG_panganifm2_radiodistribution_master.dta", replace
}
...
save "X:\Dropbox\Wellspring Tanzania Papers\wellspring_01_master\01_data\01_raw_data\pfm_radiodistribution_ra_clean.dta", replace
